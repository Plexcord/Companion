...
const typescript_is_stupid_and_errors_if_i_inline_this: ConfigArray = TSEslint.config({ ignores: ["dist", "src/webview", "node_modules", "**/__test__/**", "packages/plexcord-ast-parser/src/.plexcord-source/**", "parsers/**"] }, {
